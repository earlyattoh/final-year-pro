...
@section('title') Chapters Upload @stop
...
<div class="content">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    <h4 class="m-t-0 header-title"><b> File Submission</b></h4>
                    <p class="text-muted m-b-15 font-13">
                        Upload your project chapters so that your supervisor can review it and give you feedback.
                    </p>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="p-20">
